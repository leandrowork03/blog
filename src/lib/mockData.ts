...
`,
  ...
  },
  {
    ...
    content: `<h1 class="text-sky-700 text-4xl font-bold py-6">
Portifólio V3: Uma Jornada Interativa Pela minha carreira de Desenvolvedor Web
</h1>
...
<p><strong>React com TypeScript,
Framer Motion para animações suaves
CSS / Tailwind</strong></p> 
...
`,
    imageUrl: ['/images/p1.png', '/images/p2.png', '/images/p3.png', '/images/p4.png', '/images/p5.png', '/images/p6.png'], 
  },
  {
    id: '3',
...
<p>
  Um dos diferenciais do <strong>Controle de Gastos</strong> é a funcionalidade de grupos, onde usuários podem se reunir para monitorar receitas e despesas familiares.
  Cada grupo possui um nome, descrição e um identificador único para que outros membros possam ser adicionados. 
  Essa visão colaborativa permite um controle financeiro compartilhado e mais transparente.
</p>
...
<p>
  O sistema permite gerar relatórios em PDF com um resumo financeiro completo: receitas, despesas e saldo, tanto individuais quanto por grupo.
  Isso facilita o acompanhamento e a tomada de decisões com base em dados reais.
</p>
...
<p>
  O projeto foi construído com <strong>HTML, CSS e JavaScript puro</strong>, com persistência dos dados via <strong>localStorage</strong> e exportação de relatórios usando <strong>html2pdf.js</strong>.
</p>
...
<ul class="list-disc pl-6 space-y-2">
  <li>Dashboard com resumo do saldo, total de receitas e despesas.</li>
  <li>Interface para adicionar, visualizar e excluir transações com descrição, valor, data e tipo (entrada ou saída).</li>
  <li>Criação e entrada em grupos familiares, permitindo controle colaborativo de finanças.</li>
  <li>Exportação de relatório financeiro em PDF com um clique.</li>
</ul>

<p class="pt-4">
  O <strong>Controle de Gastos</strong> é uma aplicação prática e acessível para o gerenciamento financeiro pessoal ou em grupo,
  promovendo controle, organização e colaboração entre usuários.
</p>
...
`,
  ...
  <h3 class="font-bold text-lg mt-4">Consumo da API</h3>
  <p>Aplicação consome uma API criada por mim dentro do próprio <strong>Next</strong></p>
</div>
